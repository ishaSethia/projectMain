...
<div class="container-fluid">
	...
	<div class="card-body">
		...
		if(isset($_POST['editbtn']))
		{
			...
			$q="select * from card where id='$id'";
		...
		<div class="form-group">
       	<label>Heading</label>
       	<input type="text" name="edit_head" class="form-control" placeholder="Heading for Image." required="" value="<?php echo $row['head'];?>" >
       </div>
       ...
       <div class="form-group">
       	<label>Link</label>
       	<input type="text" name="edit_link" class="form-control" placeholder="Link for Image." required="" value="<?php echo $row['link'];?>">
       </div> 
      </div>
     <button type="submit" class="btn btn-primary" name="update">Update</button>

        <a href="car.php" class="btn btn-secondary" >Cancel</a>
    </form>
...
if (isset($_POST['update'])) {
	...
	$q="update card set head='$edit_head',image='$edit_image',detail='$edit_detail',link='$edit_link' where id=$edit_id";
	$q_run=mysqli_query($con,$q);

	if($q_run)
	{
		move_uploaded_file($_FILES["image"]["tmp_name"], "car/".$_FILES["image"]["name"]);
 	 	$_SESSION['success']="Card Updated";
 	 	echo "<script>window.location='car.php';</script>";
	...
	{
		$_SESSION['status']="Card Not Updated";
 	 	echo "<script>window.location='car.php';</script>";
