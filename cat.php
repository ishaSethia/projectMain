...
?>
   ...
   <div class="detail">
        ...
        <a href="<?php echo $row['link']?>">  <div class="headline"><?php echo $row['detail']?></div>
          <div class="background" style="background-image: url('cat/<?php echo $row['image']; ?>'); height: 100vh;"></div>
          <div class="background" style="background-image: url('cat/<?php echo $row['image']; ?>'); height: 100vh; background-size: cover; background-position: center;"></div>
        </div></a>       
